...
data WMState = WMState
    ...
    , rawLayerShell :: Ptr RiverLayerShellV1 -- Raw pointer to the layer shell manager
    ...
    , lastVisibleWindows :: Map MonitorId (Set WindowId) -- Last render-visible windows per monitor
    , layerShellOutputs :: Map MonitorId (Ptr RiverLayerShellOutputV1) -- Layer-shell output wrappers
    , layerShellSeats :: Map SeatId (Ptr RiverLayerShellSeatV1) -- Layer-shell seat wrappers
    , layerShellOutputCleanup :: Map MonitorId (IO ()) -- Layer-shell output listener cleanup
    , layerShellSeatCleanup :: Map SeatId (IO ()) -- Layer-shell seat listener cleanup
