...
data RiverLayerShellV1
data RiverLayerShellOutputV1
data RiverLayerShellSeatV1
...
foreign import capi "river-layer-shell-v1.h &river_layer_shell_v1_interface"
    riverLayerShellV1Interface :: Ptr WlInterface
...
----- layer shell requests + events

riverLayerShellV1Destroy :: Ptr RiverLayerShellV1 -> IO ()
riverLayerShellV1Destroy = river_layer_shell_v1_destroy

foreign import capi "river-layer-shell-v1.h river_layer_shell_v1_destroy"
    river_layer_shell_v1_destroy :: Ptr RiverLayerShellV1 -> IO ()

riverLayerShellV1GetOutput ::
    Ptr RiverLayerShellV1 -> Ptr RiverOutputV1 -> IO (Ptr RiverLayerShellOutputV1)
riverLayerShellV1GetOutput = river_layer_shell_v1_get_output

foreign import capi "river-layer-shell-v1.h river_layer_shell_v1_get_output"
    river_layer_shell_v1_get_output ::
        Ptr RiverLayerShellV1 -> Ptr RiverOutputV1 -> IO (Ptr RiverLayerShellOutputV1)

riverLayerShellV1GetSeat ::
    Ptr RiverLayerShellV1 -> Ptr RiverSeatV1 -> IO (Ptr RiverLayerShellSeatV1)
riverLayerShellV1GetSeat = river_layer_shell_v1_get_seat

foreign import capi "river-layer-shell-v1.h river_layer_shell_v1_get_seat"
    river_layer_shell_v1_get_seat ::
        Ptr RiverLayerShellV1 -> Ptr RiverSeatV1 -> IO (Ptr RiverLayerShellSeatV1)

riverLayerShellOutputV1Destroy :: Ptr RiverLayerShellOutputV1 -> IO ()
riverLayerShellOutputV1Destroy = river_layer_shell_output_v1_destroy

foreign import capi "river-layer-shell-v1.h river_layer_shell_output_v1_destroy"
    river_layer_shell_output_v1_destroy :: Ptr RiverLayerShellOutputV1 -> IO ()

riverLayerShellOutputV1SetDefault :: Ptr RiverLayerShellOutputV1 -> IO ()
riverLayerShellOutputV1SetDefault = river_layer_shell_output_v1_set_default

foreign import capi "river-layer-shell-v1.h river_layer_shell_output_v1_set_default"
    river_layer_shell_output_v1_set_default :: Ptr RiverLayerShellOutputV1 -> IO ()

riverLayerShellSeatV1Destroy :: Ptr RiverLayerShellSeatV1 -> IO ()
riverLayerShellSeatV1Destroy = river_layer_shell_seat_v1_destroy

foreign import capi "river-layer-shell-v1.h river_layer_shell_seat_v1_destroy"
    river_layer_shell_seat_v1_destroy :: Ptr RiverLayerShellSeatV1 -> IO ()

type RawLayerShellOutNonExclusiveArea =
    Ptr () -> Ptr RiverLayerShellOutputV1 -> CInt -> CInt -> CInt -> CInt -> IO ()

foreign import ccall "wrapper"
    mkRawLayerShellOutNonExclusiveArea ::
        RawLayerShellOutNonExclusiveArea -> IO (FunPtr RawLayerShellOutNonExclusiveArea)

newtype LayerShellOutputListener = LayerShellOutputListener
    { onLayerShellOutNonExclusiveArea ::
        Ptr RiverLayerShellOutputV1 -> Int -> Int -> Int -> Int -> IO ()
    }

riverLayerShellOutputV1AddListener ::
    Ptr RiverLayerShellOutputV1 -> LayerShellOutputListener -> IO (IO ())
riverLayerShellOutputV1AddListener out LayerShellOutputListener{..} = do
    fp0 <-
        mkRawLayerShellOutNonExclusiveArea $ \_ o x y w h ->
            onLayerShellOutNonExclusiveArea o (fi x) (fi y) (fi w) (fi h)
    lp <- newArray [castFunPtr fp0 :: FunPtr (IO ())]
    _ <- wl_proxy_add_listener (castPtr out) lp nullPtr
    pure $ freeHaskellFunPtr fp0 >> free lp

type RawLayerShellSeatFocusExclusive = Ptr () -> Ptr RiverLayerShellSeatV1 -> IO ()
type RawLayerShellSeatFocusNonExclusive = Ptr () -> Ptr RiverLayerShellSeatV1 -> IO ()
type RawLayerShellSeatFocusNone = Ptr () -> Ptr RiverLayerShellSeatV1 -> IO ()

foreign import ccall "wrapper"
    mkRawLayerShellSeatFocusExclusive ::
        RawLayerShellSeatFocusExclusive -> IO (FunPtr RawLayerShellSeatFocusExclusive)

foreign import ccall "wrapper"
    mkRawLayerShellSeatFocusNonExclusive ::
        RawLayerShellSeatFocusNonExclusive -> IO (FunPtr RawLayerShellSeatFocusNonExclusive)

foreign import ccall "wrapper"
    mkRawLayerShellSeatFocusNone ::
...
riverLayerShellSeatV1AddListener ::
    Ptr RiverLayerShellSeatV1 -> LayerShellSeatListener -> IO (IO ())
riverLayerShellSeatV1AddListener seat LayerShellSeatListener{..} = do
    fp0 <- mkRawLayerShellSeatFocusExclusive $ \_ s -> onLayerShellSeatFocusExclusive s
    fp1 <- mkRawLayerShellSeatFocusNonExclusive $ \_ s -> onLayerShellSeatFocusNonExclusive s
    fp2 <- mkRawLayerShellSeatFocusNone $ \_ s -> onLayerShellSeatFocusNone s
