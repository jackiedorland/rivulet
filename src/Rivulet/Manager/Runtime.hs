...
initialState ::
    ...
    Ptr RiverLayerShellV1 ->
    WMState
initialState windowManager xkbBindings inputManager layerShell =
    WMState
        { phase = Managing
        , rawWM = windowManager
        , rawXkb = xkbBindings
...
initialize runtime config = do
    ...
    let seatListener =
            SeatListener
                ...
                , onSeatWindowInteraction = Callbacks.onSeatWindowInteraction runtime wmPtr
